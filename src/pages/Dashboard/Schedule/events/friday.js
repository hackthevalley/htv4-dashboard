...
export default [
    ...
    },
    {
        ...
        location: 'AC223',
        description:
            'Registration, please make sure you have your acceptance ticket, and a piece of ID (student ID or government ID).',
        organizer: ['Jun Zheng'],
    ...
    },
    {
        ...
        location: 'AC223',
        description:
            "Stay in AC223 if you don't have a team yet, or want to find some new members for your team!",
        organizer: ['Jun Zheng'],
